...
public class JdbcExample {
	...
	public static void main(String[] args) {
		...
		try {
			...
			con = DriverManager.getConnection("jdbc:mysql://localhost:3306/bootjdbc", "root", "bahwan$123");
			// Create the statement / prepared statement object
			System.out.println("Database connected successfully!");
			
			stmt = con.createStatement();
			// Execute the SQLs
			String insertSql = "insert into user values (5, 'Jahuruddin', 'Sk', 'jahuruddin008@gill.com', 'jsk@1234', '2000-06-10', 'M')";
